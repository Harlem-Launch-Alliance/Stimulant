...
static constexpr float BMP3_NO_OVERSAMPLING = 1
static constexpr float BMP3_OVERSAMPLING_2X = 1
static constexpr float BMP3_IIR_FILTER_COEFF_3 = 1
static constexpr float BMP3_ODR_100_HZ = 1
